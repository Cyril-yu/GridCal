...
class AcDcBusGraphicItem(QGraphicsRectItem):
    """
      Represents a block in the diagram
      Has an x and y and width and height
      width and height can only be adjusted with a tip in the lower right corner.
    ...
    def __init__(self, diagramScene, name='Untitled', parent=None, index=0, editor=None,
                 bus: AcDcBus = None, pos: QPoint = None):
        """
        ...
        @param editor:
        """
        super(AcDcBusGraphicItem, self).__init__(parent)
        ...
        # dc line
        self.dc_line = QGraphicsLineItem(QLineF(0, 0, self.min_w, 0), self)
        self.dc_line.setPen(QPen(Qt.black, 5, Qt.DashLine))
    ...
    def change_size(self, w, h):
        ...
        # dc line
        self.dc_line.setLine(QLineF(5, 25, w-5, 25))
